...
@Data
@Component
public class AmazonReplaySQSResourceConfig {
    ...
    public AmazonReplaySQSResourceConfig(@Qualifier("applicationProperties") PropertiesConfig propertiesConfig) {
        final Map<String, Object> awsProperties = propertiesConfig.getProperties();
        this.sqsRuleRegion = (String) awsProperties.get("aws.parsing.sqs.replay.region");
        this.sqsUrl = (String) awsProperties.get("aws.parsing.sqs.replay.url");
